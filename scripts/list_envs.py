...
All the environments are registered in the `cube_manipulation` extension. They start
...
import cube_manipulation.tasks  # noqa: F401


def main():
    """Print all environments registered in `cube_manipulation` extension."""
